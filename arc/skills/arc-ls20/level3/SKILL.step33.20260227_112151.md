...
- NOTE: UP is BLOCKED at (25,49).

# Exploring Alternatives to reach Button
- Button top-left coordinate is (10, 49).
- Since UP from (25,49) is blocked, we likely need to reach (10,49) from a different column, maybe (44), (54)? Or maybe we can go UP from (25,44)? Going to investigate LEFT to (25,44) and turning UP.

# Strategy to Win 
1. Collect extender at (5,34), backtrack left to (5,29).
2. Follow downward/right serpentine path to (25,44)...
3. (Trying new path finding step: X=44 UP branch). 
