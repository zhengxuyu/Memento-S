...
2. **Collect Time Pick-ups**:
   - Stepping exactly over structures of color 11 will refill the in-game timer (visualized as a bar at the bottom, rows 61/62). If this bar depletes, the level is lost.
...
- **Action Economy & Timer Limit**: 
  - The bar at the bottom (color 11) is the in-game timer, depleting by 1 unit per action. Time pickups replenish it.
