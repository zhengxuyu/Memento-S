...
- Button target is at Y=10, X=49. Will use run_code to pathfind from (15,29) to (10,49).

# Strategy to Win 
1. If at (5,34) after collecting extender, move LEFT (ACTION3) back to main path at (5,29).
2. From (5,29), move DOWN (ACTION2) to (10,29).
3. At (10,29), RIGHT is blocked! Move DOWN to (15,29).
4. Run BFS to path to button at (10,49).
5. Open gate at (46,31), Goal target top-left is (50,54).