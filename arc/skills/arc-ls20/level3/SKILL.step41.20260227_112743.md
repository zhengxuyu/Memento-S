...
description: "Found amazing discovery: 3x3 Color 11 U-shapes are TIME EXTENDERS! Picking them up adds to the global action limit. Found multiple on Level 3."
---
...
- **Goal**: The button is at X=49, Y=10 (requires going UP from `(30,49)`). Then the final green goal is located around `(50,54)`.
...
6. Once the button is pressed, navigate to the goal at `(50,54)`.
