---
name: "Level 3: Multi-colored Goals and Action Economy"
description: "Core procedure to guide a 5x5 avatar through a grid maze to unlock gates via a 3x3 button and perfectly enclose a 3x3 goal."
---
...
- **Timer / Action Limit**: You have a global limit of 100 actions across all levels in an episode. The timer is shown as a bar (often color 11) depleting from the bottom.
- **Grid Arithmetic**: Because objects are specifically placed and the avatar moves by 5 units, you can easily verify alignment by looking at row/column coordinates modulo 5. Perfect bounds checking is critical.
- **Goals Vary By Level**: Earlier levels feature a U-shaped goal, while later levels may feature multi-colored 3x3 structures or different U-shape patterns. Always look for the 3x3 stationary cluster behind the gate.