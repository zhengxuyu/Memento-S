...
description: "Navigating Level 3: Hit a wall trying to move RIGHT at Y=10. Trying UP instead."
---
...
# Level 3 Route Info
- Start: (45,9)
- Moved UP 7 times to Y=10.
- Attempted ACTION4 (RIGHT) at Y=10, X=9. Hit an obstacle. 
- Button: Covers (11-13, 50-52). Target player pos: (10,49).

# Strategy to Win 
1. Strict 5x5 alignments avoiding obstacle walls (color 5).
2. Since RIGHT failed at Y=10, the path must either be UP (Y=5) or DOWN and then RIGHT elsewhere. Trying UP to Y=5 now.