...
description: "Navigating Level 3: Moving UP left corridor. Currently at Y=30."
---
...
- **Timer**: Episodic global limit of 100 actions. Color 11 at bottom depletes by 2 cells per action. Currently observing color 11 decreasing at col 15.

# Level 3 Route Info
- Start: (45,9)
- Currently taking continuous ACTION1 to move UP. At Y=30.
- Target is Y=5, then proceed RIGHT (ACTION4) towards button.
